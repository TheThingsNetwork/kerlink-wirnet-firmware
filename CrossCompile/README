...
For sake of kerlinkm2mtechnologies the username and password required to get their toolchain are removed. Replace __wikiuser__ and __wikipasswd__ in resources/get_toolchain.sh
